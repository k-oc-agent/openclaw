...
export const RUNTIME_FIELD_HELP: Record<string, string> = {
  ...
  "gateway.publicOrigin":
    "Externally reachable HTTP(S) origin of the Gateway. Per-requester MCP OAuth uses it to build the callback URL at /oauth/mcp/callback; configure the reverse proxy or tunnel to route that path to the Gateway.",
  "mcp.apps":
